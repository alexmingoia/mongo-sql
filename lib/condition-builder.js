...
define(function(require, exports, module){
  ...
  module.exports = function(where, table, values){
    var buildConditions = function(where, condition, column, joiner){
      joiner = joiner || ' and ';
      if (column) column = utils.quoteColumn(column, table);
      ...
      for (var key in where){
        ...
        if (typeof where[key] == 'object' && !(where[key] instanceof Date) && !(typeof Buffer !== 'undefined' && Buffer.isBuffer(where[key]))){
